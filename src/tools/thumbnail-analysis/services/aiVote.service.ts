import { userVotes } from './../types/aiVote';
...
export async function decideVotesAndReasonsWithImage(
    ai: GoogleGenAI,
...
// 投票数トップの動画を分析する関数
export async function analyzeTopVideo(
    ai: GoogleGenAI,
    voteResults: { videoId: string; votes: number }[],
    userVotes: userVotes[],
    videos: selectedVideo[],
...
export async function generateUploadedVideoAnalysis(
    ai: GoogleGenAI,
